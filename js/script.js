...
$.getJSON("./Asset/data-spasial/data-spasial/jembatan_pt.geojson", (OBJECTID) => {
  L.geoJSON(OBJECTID, {
...
$.getJSON("./Asset/data-spasial/data-spasial/admin_kelurahan_ln.geojson", (OBJECTID) => {
  L.geoJSON(OBJECTID, {
    style: {
      color: "black",
      weight: 2,
...
$.getJSON("./Asset/data-spasial/data-spasial/landcover_ar.geojson", (REMARK) => {
  L.geoJson(REMARK, {
    style: (feature) => {
